    ...
    <main>
      <section className="page-band border-b border-border/70">
        <div className="page-shell">
          <div className="mx-auto max-w-5xl space-y-8 py-4 text-center md:py-8">
            <span className="page-kicker">精选 / 投稿 / 发现</span>
            <div className="space-y-5">
              <h1 className="mx-auto max-w-4xl text-5xl font-semibold leading-[0.98] text-text md:text-6xl lg:text-7xl">
                发现更有审美的 vibe coding 作品。
              </h1>
              <p className="mx-auto max-w-3xl text-base leading-8 text-text/66 md:text-lg">
          ...
          <div className="mt-8 grid gap-4 border-t border-border pt-6 sm:grid-cols-3">
            {[
              ...
              <div key={title} className="rounded-lg border border-border/70 bg-white/55 p-4">
        ...
        <div className="page-shell">
          <div className="mb-6 flex items-end justify-between gap-4">
            <div>
              ...
              <p className="section-lead">只展示仍有精选项目的分类，避免空分类和泛项目干扰。</p>
            </div>
            <Link href="/discover" className="text-sm font-medium text-text">
              查看全部
            </Link>
          </div>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {categories.map((category) => (
              <Link
                ...
                className="panel px-4 py-4 text-sm font-medium text-text transition hover:-translate-y-0.5 hover:border-primary/25 hover:bg-white"
              >
                {category}
              </Link>
            ))}
